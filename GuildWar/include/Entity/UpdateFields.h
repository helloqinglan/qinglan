...
enum EUnitFields
{
	...
	// ***TODO*** 这里有个问题, 为什么mangos中设定的是Size: 2
	UNIT_FIELD_BASEATTACKTIME			= OBJECT_END + 0x008D,	// 基本攻击速度, Size: 1, Type: FLOAT
	UNIT_FIELD_OFFHANDATTACKTIME		= OBJECT_END + 0x008E,	// 空手攻击速度, Size: 1, Type: FLOAT
	UNIT_FIELD_RANGEDATTACKTIME			= OBJECT_END + 0x008F,	// 远程攻击速度, Size: 1, Type: FLOAT
	...
	UNIT_FIELD_BASE_MANA				= OBJECT_END + 0x00C9,	// ***TODO*** 基本法力值, Size: 1, Type: INT
